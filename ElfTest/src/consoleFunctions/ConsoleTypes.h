...
// Elfscript non PoD Impementation:
IMPLEMENT_ENGINE_TYPE_TRAITS(Color4F)
IMPLEMENT_ENGINE_TYPE_TRAITS(RectI)
IMPLEMENT_ENGINE_TYPE_TRAITS(RectF)
IMPLEMENT_ENGINE_TYPE_TRAITS(Point2I)
IMPLEMENT_ENGINE_TYPE_TRAITS(Point2F)
IMPLEMENT_ENGINE_TYPE_TRAITS(Point3F)
