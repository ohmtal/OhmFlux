...
namespace DSP {
    ...
    struct BitcrusherSettings {
        ...
        void getBinary(std::ostream& os) const {
            ...
            DSP_STREAM_TOOLS::write_binary(os, bits);
            DSP_STREAM_TOOLS::write_binary(os, sampleRate);
        ...
        bool  setBinary(std::istream& is) {
            ...
            DSP_STREAM_TOOLS::read_binary(is, bits);
            DSP_STREAM_TOOLS::read_binary(is, sampleRate);
