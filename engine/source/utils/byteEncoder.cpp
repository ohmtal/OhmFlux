...
namespace ByteEncoder {
    ...
    // ------------------ BASE 64 --------------------------
    // ... encode
    std::string Base64::encode(const unsigned char* data, uint32_t len) {
        std::string out;
    ...
    std::string Base64::encode(const std::stringstream& stream) {
    ...
    // ... decode
    uint32_t Base64::decode(const std::string& input, unsigned char* output) {
    ...
    // ... encode with string stream
    bool Base64::decode(const std::string& input, std::stringstream& output) {
        // validate len
