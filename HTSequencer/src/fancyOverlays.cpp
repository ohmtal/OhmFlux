...
//------------------------------------------------------------------------------
void SequencerGui::Draw4OP_Algorithm0Overlay(float nodeSize, float spacing) {
...
//------------------------------------------------------------------------------
void SequencerGui::Draw4OP_Algorithm1Overlay(float nodeSize, float spacing) {
    if (ImGui::BeginTooltip()) {
...
//------------------------------------------------------------------------------
void SequencerGui::Draw4OP_Algorithm2Overlay(float nodeSize, float spacing) {
    if (ImGui::BeginTooltip()) {
...
//------------------------------------------------------------------------------
void SequencerGui::Draw4OP_Algorithm3Overlay(float nodeSize, float spacing) {
    if (ImGui::BeginTooltip()) {
...
//------------------------------------------------------------------------------
void SequencerGui::Draw2OP_Additive_Overlay(float nodeSize, float spacing) {
    if (ImGui::BeginTooltip()) {
...
//------------------------------------------------------------------------------
void SequencerGui::Draw2OP_FM_Overlay(float nodeSize, float spacing) {
    if (ImGui::BeginTooltip()) {
